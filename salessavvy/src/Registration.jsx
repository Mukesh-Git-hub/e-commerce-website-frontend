...
{error && <p className="error-message">{error}</p>}
          ...
          <form onSubmit={handleSignUp} className='form-content'>
              ...
              <input type="text" id="username" placeholder='enter your name'  value={username} onChange={(e)=>{setUsername(e.target.value)}} required className='form-input'/>
            </div>
              <div className="form-group">
        ...
        <div className="form-group">
          ...
          <p className="form-footer">Already a user? {" "}
            <a href="/" className='form-link'>login in here</a>
          </p>
